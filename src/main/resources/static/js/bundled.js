...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseCarCalc = __webpack_require__(28);

	var _BaseCarCalc2 = _interopRequireDefault(_BaseCarCalc);

	var _PPHCalc = __webpack_require__(29);

	var _PPHCalc2 = _interopRequireDefault(_PPHCalc);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var lodash = __webpack_require__(30);

	var app = new _vue2.default({
	    el: '#body-container',
	    components: {
	        'base-car-calc': _BaseCarCalc2.default,
	        'physics-profile-calc': _PPHCalc2.default
	    },

	    created: function created() {
	        window.axios = _axios2.default.create();
	        window._ = lodash;
	    }
	});
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        axios.get('/api/baseCarInfo').then(function (_ref) {
	            var data = _ref.data;

	            _this.carIdMap = _.keyBy(data, function (o) {
	                return o.carId;
	            });

	            _this.carId = data[0].carId;
	        });
	    },
	    ...
	    computed: {
	        ...
	        generatedCode: function generatedCode() {
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        axios.get('/api/physicsInfo').then(function (_ref) {
	            var data = _ref.data;
